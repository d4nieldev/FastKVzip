...
The reported suite combines RULER \citep{hsieh2024ruler} and SCBench
\citep{li2025scbench}. Appendix~\ref{app:benchmarks} explains every supported
...
\input{sections/summarization_alignment}
...
\clearpage
\input{sections/appendix_retention_curves}
